...
# Configuración visual (Debe ir al principio)
...
try:
    ...
    # Se debe agregar country='HN' (Honduras) para que Spotify sepa qué mercado consultar
    ...
    with col1:
        # Nota: Este dato de posición es manual, se puede automatizar después
